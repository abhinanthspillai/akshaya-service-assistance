...
if TYPE_CHECKING:
    from app.models.service import CentreSupportedService
...
class AkshayaCentre(Base):
    ...
    supported_services: Mapped[list["CentreSupportedService"]] = relationship(
        "CentreSupportedService", back_populates="centre"
    )
