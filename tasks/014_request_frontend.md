# Citizen request creation frontend

## Objective
Implement request creation, centre selection, submit and request detail/timeline shell.
...
## Acceptance Criteria
E2E citizen path works through WAITING_FOR_CENTRE.
