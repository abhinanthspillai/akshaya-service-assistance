# Assignment/history schema and service logic

## Objective
Add later migration for assignments + request history required for acceptance milestone.
...
## Acceptance Criteria
Atomic assignment/history persistence; previous access can be revoked on reassignment.
