# Employee queue and capacity-aware acceptance

## Objective
Implement queue metadata, scoped visibility, atomic accept and capacity enforcement.
...
## Acceptance Criteria
Two concurrent accepts cannot produce conflicting assignment; capacity enforced.
