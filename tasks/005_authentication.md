# Citizen registration and JWT authentication

## Objective
Implement Argon2, citizen-only registration, login, /auth/me and auth dependencies.
...
## Acceptance Criteria
Auth security tests in TEST_STRATEGY pass.
