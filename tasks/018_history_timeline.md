# Request history API/UI for implemented transitions

## Objective
Expose role-filtered request history/timeline.
...
## Acceptance Criteria
Citizen/staff see allowed history; timestamps/actions correct.
