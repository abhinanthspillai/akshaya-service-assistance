# Service catalogue Batch 1 schema

## Objective
Implement services, document requirements, file types, interaction requirements, centre supported services.
...
## Acceptance Criteria
Migrations/models conform; Type A/B/C and constraints enforced.
