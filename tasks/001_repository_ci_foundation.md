...
## Objective
Create backend/frontend skeleton, environment examples, test commands and initial GitHub CI checks.
...
## Acceptance Criteria
Health/build/test commands execute; CI skeleton is present; no secrets committed.
