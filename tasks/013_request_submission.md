# Request submission state action

## Objective
Implement submit action and DRAFT -> SUBMITTED -> WAITING_FOR_CENTRE routing transaction.
...
## Acceptance Criteria
Invalid state/preconditions ->409; retry does not duplicate authoritative effects.
