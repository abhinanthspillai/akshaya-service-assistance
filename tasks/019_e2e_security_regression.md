# Milestone E2E and security regression

## Objective
Automate citizen register->service->request->submit->employee accept workflow plus authz abuse cases.
...
## Acceptance Criteria
Required E2E passes in CI/staging; cross-user/cross-centre tests fail safely.
