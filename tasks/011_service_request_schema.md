# Service request Batch 1 schema

## Objective
Implement service_requests with approved states/snapshots and indexes.
...
## Acceptance Criteria
New request can persist DRAFT and snapshots; constraints/migrations pass.
