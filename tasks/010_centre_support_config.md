# Centre-supported service management

## Objective
Implement supported-service API and admin UI.
...
## Acceptance Criteria
Authorized admin enables/disables service support; unauthorized centre change blocked.
