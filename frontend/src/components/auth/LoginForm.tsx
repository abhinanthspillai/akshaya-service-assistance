...
export function LoginForm() {
 ...
 <div>
 <label className="block text-sm font-semibold text-ink-900 mb-2">Your email</label>
 <input
 type="email"
 required
 value={email}
 ...
 <Link to="/forgot-password" className="text-sm font-semibold text-ink-900 hover:text-ink-900 transition-colors">
 Forgot Password?
 </Link>
 </div>
 </div>
