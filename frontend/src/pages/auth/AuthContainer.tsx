...
export function AuthContainer() {
 ...
 <div className="lg:hidden w-full max-w-[500px] bg-white rounded-2xl shadow-sm p-6 sm:p-10 border border-ink-100 relative">
 
 {/* Mobile Header & Toggle */}
 <div className="flex items-center gap-2 mb-8 text-ink-900 justify-center">
 ...
 <div className="flex bg-ink-100 p-1 rounded-2xl mb-8 relative max-w-sm mx-auto">
 <button 
 onClick={() => navigate('/login', { replace: true })}
 className={clsx("flex-1 py-2 text-sm font-semibold rounded-2xl transition-colors z-10", isLogin ? "text-ink-900" : "text-ink-500 hover:text-ink-700")}
 >Sign In</button>
 <button 
 ...
 <div className="hidden lg:flex w-full max-w-[1000px] h-[600px] bg-white rounded-2xl shadow-sm relative overflow-hidden border border-ink-100">
